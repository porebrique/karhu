...
elRTE.prototype.options   = {
	...
	panels      : {
		...
		c_elements   : ['horizontalrule', 'blockquote', 'div', 'stopfloat', 'css', 'nbsp', 'smiley', 'pagebreak'],
		c_copypaste  : ['removeformat', 'docstructure'],
		c_links      : ['link', 'unlink']
	},
	toolbars    : {
		tiny     : ['style'],
		...
		crecca 	 : ['c_copypaste', 'undoredo', 'style', 'alignment', 'lists', 'c_links', 'c_elements', 'images', 'fullscreen']
