...
(function (ng) {
    ...
    mdl.controller('GalleryListCtrl', ['$scope', '$state', '$stateParams',  'Gallery',
        function ($scope, $state, $stateParams, Gallery) {

            $scope.config = Gallery.config;
            
            Gallery.Folder
                .getList({request_type: 'list'})
    ...
    mdl.controller('GalleryFolderCtrl', ['APP_ROOT_FOLDER', '$scope', '$cookies', '$state', '$stateParams', '$filter', 'Lightbox', 'SingleFileUploader', 'Gallery',
                                         function (ROOT, $scope, $cookies, $state, $stateParams, $filter, Lightbox, SingleFileUploader, Gallery) {
