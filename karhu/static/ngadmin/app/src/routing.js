...
app.controller('RootCtrl', ['$scope', 'CONFIG', function($scope, CONFIG){
	$scope.resolvedConfig = CONFIG;
}])

app.config(['$stateProvider', '$urlRouterProvider', '$locationProvider', 'APP_ROOT_FOLDER', function($stateProvider, $urlRouterProvider, $locationProvider, APP_ROOT_FOLDER){
		...
		.state('root', {
		    ...
		    resolve: {
		        ...
		        CONFIG: function(configService){
		          ...
		          //console.log('were in resolvingm returning ', c)
		          return c;
		        }		        
		      },				
			data: {},
